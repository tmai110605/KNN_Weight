...
def main() -> int:
    ...
    from knn_weight.data import load_ag_news
    from knn_weight.vectorize import build_tfidf, vectorize_text

    parser = argparse.ArgumentParser(description="Run (weighted) cosine KNN on AG News")
    ...
    splits = load_ag_news(train_size=args.train_size, test_size=args.test_size)
